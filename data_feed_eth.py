"""
CryptoTrader AI -- data_feed_eth.py
...
log = logging.getLogger("CryptoTrader.DataFeed.ETH")
...
class ETHDataFeed:
    """
    CryptoTrader AI -- ETH/GBP dual-timeframe data feed.
    ...
    def __init__(self) -> None:
        ...
        log.info(
            "CryptoTrader AI | ETHDataFeed ready | capital=GBP %.2f",
            self.capital_gbp,
        )
    ...
    def initialise(self) -> None:
        log.info("=== CryptoTrader AI -- Initialising ETH data feed ===")
        for tf in ("1d", "1h", "5m"):
    ...
    def refresh(self) -> None:
        log.info("=== CryptoTrader AI -- Refreshing ETH ===")
        for tf in ("1d", "1h", "5m"):
...
if __name__ == "__main__":
    log.info("CryptoTrader AI -- ETH data feed test starting...")
    feed = ETHDataFeed()
    feed.initialise()
    feed.print_status()
