"""
CryptoTrader AI -- paper_trader_btc.py
...
log = logging.getLogger("CryptoTrader.PaperTrader")
...
class PaperTrader:
    ...
    def __init__(self) -> None:
        ...
        log.info("CryptoTrader AI | PaperTrader ready")
    ...
    def _save_summary(self) -> None:
        ...
        lines = [
            "=" * 50,
            "CryptoTrader AI -- Trading Summary",
    ...
    def print_status(self) -> None:
        s = self.strategy
        log.info("=" * 60)
        log.info("CryptoTrader AI -- Paper Trader Status")
        log.info("-" * 60)
...
if __name__ == "__main__":
    ...
    log.info("CryptoTrader AI -- PaperTrader self-test starting...")
    trader = PaperTrader()
    bar_1h = pd.Series({
        "ssl_bull":       True,
        "rsi":            62.0,
    ...
    log.info("CryptoTrader AI -- PaperTrader self-test complete.")