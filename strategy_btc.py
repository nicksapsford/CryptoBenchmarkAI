"""
CryptoTrader AI — strategy_btc.py
...
log = logging.getLogger("CryptoTrader.Strategy")
...
class BTCStrategy:
    """
    CryptoTrader AI — Conservative BTC/GBP Strategy
    ...
    def __init__(self, capital_gbp: float = 1000.0) -> None:
        ...
        log.info(
            "CryptoTrader AI | Strategy ready | capital=£%.2f | "
    ...
    def print_status(self) -> None:
        ...
        log.info("=" * 60)
        log.info("CryptoTrader AI — Strategy Status")
...
if __name__ == "__main__":
    ...
    log.info("CryptoTrader AI — Strategy self-test starting...")
