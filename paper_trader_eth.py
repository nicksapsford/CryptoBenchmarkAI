"""
CryptoTrader AI -- paper_trader_eth.py
...
log = logging.getLogger("CryptoTrader.PaperTrader.ETH")
...
class PaperTraderETH:
    ...
    def __init__(self) -> None:
        ...
        log.info("CryptoTrader AI | ETH PaperTrader ready")
    ...
    def _save_summary(self) -> None:
        ...
        lines = [
            "=" * 50,
            "CryptoTrader AI -- ETH/GBP Trading Summary",
    ...
    def print_status(self) -> None:
        s = self.strategy
        log.info("=" * 60)
        log.info("CryptoTrader AI -- ETH Paper Trader Status")
        log.info("-" * 60)
