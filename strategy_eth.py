"""
CryptoTrader AI -- strategy_eth.py
...
log = logging.getLogger("CryptoTrader.Strategy.ETH")
...
class ETHStrategy:
    """
    CryptoTrader AI -- Conservative ETH/GBP Strategy
    ...
    def __init__(self, capital_gbp: float = 1000.0) -> None:
        ...
        log.info(
            "CryptoTrader AI | ETH Strategy ready | capital=GBP %.2f | "
    ...
    def print_status(self) -> None:
        log.info("=" * 60)
        log.info("CryptoTrader AI -- ETH Strategy Status")
